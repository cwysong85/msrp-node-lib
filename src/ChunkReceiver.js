...
module.exports = function (MsrpSdk) {
  ...
  class ChunkReceiver {
     ...
     *
     * @param {Message.Request} firstChunk - The first received chunk.
     * This must contain the first byte of the incoming message. Later chunks may arrive out-of-order.
     * @param {Number} bufferSize - The threshold of data to cache in memory writing the chunks out
     * to a Buffer (which will generally get stored to disk).
     */
    constructor(firstChunk, bufferSize) {
      ...
      this.isFile = firstChunk.contentDisposition &&
        (firstChunk.contentDisposition.type === 'attachment' || firstChunk.contentDisposition.type === 'render');
